...
public class SourceLoader {
	...
	public static void add(XMLElement xe){
		if(smap.get(xe.getId())==null){
			...
			throw new SameIDNameException("收集资源["+xe.getId()+"]的时候出现了错误，可能资源内有重名的资源，请检查资源名称");
		}
	}
	...
	public static void add(StringBlock block){
		if(smap.get(block.getLocationName())==null){
			...
			throw new SameIDNameException("收集资源["+block.getLocationName()+"]的时候出现了错误，可能资源内有重名的资源，请检查资源名称");
		}
	}
